...
// File: lockFactory/interfaces/IFeeAggregator.sol
...
// File: lockFactory/interfaces/IPSIPadTokenLockFactory.sol
...
interface IPSIPadTokenLockFactory {
    ...
    function lock(address token, uint256 amount, uint256 start_time, uint256 duration) external payable returns(uint256);
    function lock(address token, uint256 amount, uint256 start_time, uint256 duration, address owner) external payable returns(uint256);
...
// File: lockFactory/PSIPadTokenLockFactory.sol
...
contract TokenLockFactory is IPSIPadTokenLockFactory, Initializable, OwnableUpgradeable {
    using AddressUpgradeable for address;
